...
public class IrsPerformanceDashboardService {
              ...
              switch (column) {
                ...
                case BOTTLES_USED:
                  ...
                  bottlesUsedColumnData.setValue(
                      userPerformancePerDate.getValue().getFieldAggregate().get(IRS_LITE_SACHET_COUNT)
                          == null
                          ? 0 :
                          userPerformancePerDate.getValue().getFieldAggregate().get(IRS_LITE_SACHET_COUNT)
                              .get("integer")
  ...
  private ColumnData getNumberOfBottlesOpened(UserPerformanceAggregate userPerformanceAggregate) {
    ...
    averageHoursWorkedColumnData.setValue(
        userPerformanceAggregate.getSumOfField(IRS_LITE_SACHET_COUNT, "integer"));
    return averageHoursWorkedColumnData;
  }
  ...
  private ColumnData getNumberOfBottlesUsageRate(
    ...
    Long sachetCount = userPerformanceAggregate.getSumOfField(IRS_LITE_SACHET_COUNT, "integer");

    Long sprayed = userPerformanceAggregate.getCountOfFieldForValue(IRS_LITE_SPRAYED, Boolean.TRUE);
