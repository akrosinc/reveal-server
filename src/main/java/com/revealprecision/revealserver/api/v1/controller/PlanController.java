...
public class PlanController {
    ...
    @GetMapping("{planId}/assigned-locations/{organizationId}")
    public ResponseEntity<List<UUID>> findSelectedLocationsAssignedForOrganization(@PathVariable("planId") UUID planId, @PathVariable("organizationId") UUID organizationId) {
        return ResponseEntity.ok(planAssignmentService.findSelectedLocationsAssignedForOrganization(planId, organizationId));
    }
}