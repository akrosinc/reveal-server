...
public class SettingsController {
  ...
  public ResponseEntity<SettingConfigurationResponse> getSettings(@Parameter(description = "used to filter the type of configs to fetch") @RequestParam(name = "identifier", defaultValue = "global_configs") String identifier,
    ...
    return ResponseEntity.status(HttpStatus.OK).body(SettingConfigurationResponseFactory.fromSettingsAndSettingTypeIdentifier(settingService.findExistingSettingsByTypeIdentifier(identifier),identifier));
  }
