...
public interface TaskRepository extends JpaRepository<Task, UUID>,
  ...
  @Query(
      "SELECT new com.revealprecision.revealserver.persistence.domain.Task(t.identifier,t.plan.identifier,t.serverVersion,t.taskFacade,t.location.identifier) from  Task t "
