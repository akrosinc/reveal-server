...
FROM plan_locations pl
         ...
         LEFT JOIN ( SELECT pl_1.identifier AS location_id,
                            ...
                            count(*) FILTER(WHERE l_1.location_property ->>'surveyLocationType' is null OR l_1.location_property ? 'surveyLocationType' = false)  as location_without_survey_location_type,
