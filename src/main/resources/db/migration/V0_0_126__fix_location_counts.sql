...
SELECT parents.location_hierarchy_identifier,
       ...
       count(*) FILTER(WHERE l.location_property ->>'surveyLocationType' is null OR l.location_property ? 'surveyLocationType' = false) as location_without_survey_location_type,
       count(*) FILTER(WHERE l.location_property ->>'surveyLocationType'='waterbody') as water_body_count
