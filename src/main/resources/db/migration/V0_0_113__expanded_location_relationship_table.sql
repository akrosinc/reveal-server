...
FROM (SELECT arr.item_object AS parent,
      ...
      FROM location_relationship lr,
         ...
         LEFT JOIN geographic_level gl ON gl.identifier = l.geographic_level_identifier WITH DATA;

CREATE UNIQUE INDEX ON location_relationships (location_hierarchy_identifier, location_parent_identifier, location_identifier);