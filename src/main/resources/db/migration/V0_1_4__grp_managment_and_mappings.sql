...
ALTER TABLE organization_role_permission
DROP CONSTRAINT IF EXISTS fk_org_role_perm_role;

ALTER TABLE organization_role_permission
    ADD CONSTRAINT fk_org_role_perm_role
        FOREIGN KEY (organization_role_id)
            REFERENCES organization_role(identifier)
            ON DELETE CASCADE;

ALTER TABLE organization_role_permission
DROP CONSTRAINT IF EXISTS fk_org_role_perm_permission;

ALTER TABLE organization_role_permission
    ADD CONSTRAINT fk_org_role_perm_permission
...
(
    ...
    organization_role_id UUID NOT NULL,
    CONSTRAINT pk_organization_role_mapping
    PRIMARY KEY (organization_id, organization_role_id)
    );

ALTER TABLE organization_role_mapping
DROP CONSTRAINT IF EXISTS fk_org_role_map_org;

ALTER TABLE organization_role_mapping
    ADD CONSTRAINT fk_org_role_map_org
...
ALTER TABLE organization_role_mapping
    ADD CONSTRAINT fk_org_role_map_role
        FOREIGN KEY (organization_role_id)
            REFERENCES organization_role(identifier)
            ON DELETE CASCADE;
...
-- INDEX
CREATE INDEX IF NOT EXISTS idx_org_role_mapping_role
...
DROP CONSTRAINT IF EXISTS fk_org_location_organization;

ALTER TABLE organization_location
    ADD CONSTRAINT fk_org_location_organization
        FOREIGN KEY (organization_id)
            REFERENCES organization(identifier)
            ON DELETE CASCADE;

ALTER TABLE organization_location
DROP CONSTRAINT IF EXISTS fk_org_location_location;

ALTER TABLE organization_location
    ADD CONSTRAINT fk_org_location_location
...
-- INDEX
CREATE INDEX IF NOT EXISTS idx_org_location_org
