CREATE TABLE IF NOT EXISTS location_above_structure
(
    ...
    PRIMARY KEY (location_hierarchy_identifier, plan_identifier, parent_location_identifier,
                 location_above_structure_identifier)
);